      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>We have more than a hundreds of cars for you to choose. </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>Not every vehicle is the same and not everyone can afford each and every vehicle
type. So with RENT n GO you can book any vehicle anytime and be off on your great adventure in no time.</p>
    </div>
    <div class="row"> 
